...
const formData = {
  email: '212@gmail.com',
  password: '123456',
  displayName: 'Lisandro Bohorquez',
}
...
export const RegisterPage = () => {
  ...
  const isCheckingAuthentication = useMemo(() => status === 'chacking', [status]);
  ...
  return (
    <AuthLayout title='Crear cuenta'>
      <form onSubmit={onSubmit} className="animate__animated animate__fadeIn animate__faster">
        ...
        <Grid container>
          <Grid item xs={12}>
            <TextField label="Nombre" type="text" placeholder="Nombre" fullWidth name="displayName" value={displayName} onChange={onInputChange}
              error={!!displayNameValid && formSubmitted} helperText={displayNameValid} />
          </Grid>
          <Grid item xs={12} sx={{ mt: 2 }}>
            <TextField label="Correo" type="email" placeholder="mail@google.com" fullWidth name="email" value={email} onChange={onInputChange}
